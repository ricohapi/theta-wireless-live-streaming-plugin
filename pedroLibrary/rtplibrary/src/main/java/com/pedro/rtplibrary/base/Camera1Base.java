...
public abstract class Camera1Base
  ...
  public int getLcdBrightness() {
    return cameraManager.getLcdBrightness();
  }

  public int getLedPowerBrightness(int ledId) {
    return cameraManager.getLedPowerBrightness(ledId);
  }

  public int getLedStatusBrightness(int ledId) {
    return cameraManager.getLedStatusBrightness(ledId);
  }

  public void ctrlBrightness(int brightness) {
    cameraManager.ctrlLcdBrightness(brightness);
  }

  public void ctrlLedPowerBrightness(int ledId, int brightness) {
    cameraManager.ctrlLedPowerBrightness(ledId, brightness);
  }

  public void ctrlLedStatusBrightness(int ledId, int brightness) {
    cameraManager.ctrlLedStatusBrightness(ledId, brightness);
  }
